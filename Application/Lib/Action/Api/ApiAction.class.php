	...
	public function publish($id) {
		...
		if(!empty($result))
		{
			...
			if(!empty($user_info))
			{
				...
				$data['msgtype'] = 'text';
				$data['text']['content'] = '<a href="http://fen.izhifubao.com/list.php">点击开始疯狂涨粉吧</a>';
...
//-----------自动发货
	public function autofahuo($id) {
			...
			if(!empty($user_info))
			{
				...
				$data['touser'] = $user_info['uid'];
				$data['msgtype'] = 'text';
				$data['text']['content'] = '<a href="http://fen.izhifubao.com/list.php?uid='. $user_info['uid'] .'">点击开始疯狂涨粉吧</a>';
