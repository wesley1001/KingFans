...
<img style="width:500px;" src="images/alipaybg.png" />
</div>

<Iframe style="display:block; margin:0 auto; width:500px; height:450px; " id="oTencent" src="" frameborder="no" border="0" name="main"></iframe> 
<div style="font-size:14px;text-align:center; display:block; width:500px; margin:0px auto; color:red; background:#FFF; height:50px; line-height:50px; ">
...
<div style="position:absolute; background:#e6e6e6; overflow:hidden; top:0; left:0; width:100%; height:100%; z-index:-50; " id="balck_bg">
</div>
