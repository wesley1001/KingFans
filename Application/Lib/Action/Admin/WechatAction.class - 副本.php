			...
			case Wechat::MSGTYPE_EVENT :
				...
				if ($eventype ['event'] == "CLICK") {
					if( $eventype ['key']=='GET_PIC')
					{
						...
						{
							$text = '您还不是族长，不能为您生成推广图片，<a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx574e1b7032516d6d&redirect_uri=http%3A%2F%2Fmao.8208111.com%2Findex.php%3Fg%3DApp%26m%3DIndex%26a%3Dindex_info%26refresh%3D1&response_type=code&scope=snsapi_base&state=#wechat_redirect">立即购买</a>成为族长,开始赚钱！';
					...
					elseif( $eventype ['key']=='GET_URL')
					{
						...
						{
							$text = '您还不是族长，不能为您生成推广链接，<a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx574e1b7032516d6d&redirect_uri=http%3A%2F%2Fmao.8208111.com%2Findex.php%3Fg%3DApp%26m%3DIndex%26a%3Dindex_info%26refresh%3D1&response_type=code&scope=snsapi_base&state=#wechat_redirect">立即购买</a>成为族长,开始赚钱！';
							$weObj->text ( $text )->reply ();
						}
						exit ();
					}
...
如果已经知道怎么玩，请直接<a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx574e1b7032516d6d&redirect_uri=http%3A%2F%2Fmao.8208111.com%2Findex.php%3Fg%3DApp%26m%3DIndex%26a%3Dindex_info%26refresh%3D1&response_type=code&scope=snsapi_base&state=#wechat_redirect">点击购买</a>成为族长，开启睡觉赚钱新模式哦！';
					}
					else
					{
						if(!empty($user["l_id"]))
