			...
			case Wechat::MSGTYPE_EVENT :
				...
				if ($eventype ['event'] == "CLICK") {
					if( $eventype ['key']=='GET_PIC')
					{
						...
						{
							$text = '您还不是族长，不能为您生成推广图片和疯狂加粉，<a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx0974ef05805148bc&redirect_uri=http%3A%2F%2Fmao.8208111.com%2Findex.php%3Fg%3DApp%26m%3DIndex%26a%3Dindex_info%26refresh%3D1&response_type=code&scope=snsapi_base&state=#wechat_redirect">立即购买</a>成为族长,开始赚钱疯狂加粉！';
					...
					elseif( $eventype ['key']=='GET_UURL')
					{
						...
						if($usersresult['member']==1)
						{
							$url = ' <a href="http://fen.izhifubao.com/list.php?uid='.$usersresult['uid'].'">点击开始疯狂加粉</a>';
							$weObj->text ( $url )->reply ();
						}
						else
						{
					...
					{
						$text = '恭喜您由：【'.$message_name.'】推荐成为'.$message_name.'的第【20875'.$result['id'].'】位会员！2015年'.$message_name.'引领你开启“赚钱加粉新模式”，带你一起赚钱一起飞！
							
如果您是新手请<a href="http://mp.weixin.qq.com/s?__biz=MzAwNzU3NTc5MQ==&mid=206246863&idx=1&sn=25a0176801135d610bb912e2d5db0eaf#rd">点击这里</a>快速学习如何赚钱！
如果已经知道怎么玩，请直接<a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx0974ef05805148bc&redirect_uri=http%3A%2F%2Fmao.8208111.com%2Findex.php%3Fg%3DApp%26m%3DIndex%26a%3Dindex_info%26refresh%3D1&response_type=code&scope=snsapi_base&state=#wechat_redirect">点击购买</a>成为族长，开启睡觉赚钱新模式哦！';
					}
					else
					{
						if(!empty($user["l_id"]))
						{
							...
							$text = '恭喜您由【'.$user_info['nickname'].'】推荐成为'.$message_name.'的第【20875'.$user_id.'】位会员.购买马上成为'.$message_name.'的族长，2015年'.$message_name.'引领你开启“赚钱加粉新模式”，带你一起赚钱一起飞！
...
如果已经知道怎么玩，请直接<a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx0974ef05805148bc&redirect_uri=http%3A%2F%2Fmao.8208111.com%2Findex.php%3Fg%3DApp%26m%3DIndex%26a%3Dindex_info%26refresh%3D1&response_type=code&scope=snsapi_base&state=#wechat_redirect">点击购买</a>成为族长，开启睡觉赚钱新模式哦！';
						...
						{
							$text = '欢迎您【'.$wx_info['nickname'].'】关注'.$message_name.'，2015年'.$message_name.'引领你开启“赚钱加粉新模式”，带你一起赚钱一起飞！
